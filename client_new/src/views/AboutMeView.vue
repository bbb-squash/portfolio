...
const strengthFinderItems: StrengthFinderItem[] = [
  {
    color: 'accent',
    text: 'ポジティブ'
  },
  ...
  <v-container>
    <v-row>
      <v-col class="text-center">
        <h1 class="text-primary font-weight-bold mb-4">About Me</h1>
        <v-divider />
        <p class="text-h5 text-primary font-weight-black mb-4">Profile</p>
            ...
            <div :class="mdAndUp ? 'd-flex' : undefined">
              ...
              >
                ...
                <div :class="[...(smAndUp ? ['d-flex', 'justify-space-between'] : []), 'mt-4']">
                  <div
                    v-for="(item, index) in strengthFinderItems"
                    :key="index"
